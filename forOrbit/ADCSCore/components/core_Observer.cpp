...
ObserverClass::ObserverClass()
    ...
    last_star_update_time(static_cast<Param::TimeReal>(0.0)),
    last_quest_update_time(static_cast<Param::TimeReal>(0.0)),
...
void ObserverClass::propagate(const Vector3& omega_meas, Scalar dt) {
    ...
    F(0,0) = static_cast<Scalar>(0.0);          F(0,1) = omega_hat(2); F(0,2) = -omega_hat(1); F(0,3) = static_cast<Scalar>(-1.0);    F(0,4) = static_cast<Scalar>(0.0);      F(0,5) = static_cast<Scalar>(0.0);
    F(1,0) = -omega_hat(2); F(1,1) = static_cast<Scalar>(0.0);        F(1,2) = omega_hat(0);  F(1,3) = static_cast<Scalar>(0.0);     F(1,4) = static_cast<Scalar>(-1.0);     F(1,5) = static_cast<Scalar>(0.0);
    F(2,0) = omega_hat(1);  F(2,1) = -omega_hat(0); F(2,2) = static_cast<Scalar>(0.0);         F(2,3) = static_cast<Scalar>(0.0);     F(2,4) = static_cast<Scalar>(0.0);      F(2,5) = static_cast<Scalar>(-1.0);
    F(3,0) = static_cast<Scalar>(0.0); F(3,1) = static_cast<Scalar>(0.0); F(3,2) = static_cast<Scalar>(0.0); F(3,3) = -static_cast<Scalar>(1.0)/tau_bias; F(3,4) = static_cast<Scalar>(0.0); F(3,5) = static_cast<Scalar>(0.0);
    F(4,0) = static_cast<Scalar>(0.0); F(4,1) = static_cast<Scalar>(0.0); F(4,2) = static_cast<Scalar>(0.0); F(4,3) = static_cast<Scalar>(0.0); F(4,4) = -static_cast<Scalar>(1.0)/tau_bias; F(4,5) = static_cast<Scalar>(0.0);
    F(5,0) = static_cast<Scalar>(0.0); F(5,1) = static_cast<Scalar>(0.0); F(5,2) = static_cast<Scalar>(0.0); F(5,3) = static_cast<Scalar>(0.0); F(5,4) = static_cast<Scalar>(0.0); F(5,5) = -static_cast<Scalar>(1.0)/tau_bias;
    ...
    Scalar exp_term = std::exp(-static_cast<Scalar>(2.0) * dt / tau_bias);
    ...
    P = static_cast<Scalar>(0.5) * (P + P.transpose()); // Ensure symmetry
}
...
void ObserverClass::star_tracker_update(const Quat& q_meas) {
    ...
    H(0,0) = static_cast<Scalar>(1.0); H(0,1) = static_cast<Scalar>(0.0); H(0,2) = static_cast<Scalar>(0.0); H(0,3) = static_cast<Scalar>(0.0); H(0,4) = static_cast<Scalar>(0.0); H(0,5) = static_cast<Scalar>(0.0);
    H(1,0) = static_cast<Scalar>(0.0); H(1,1) = static_cast<Scalar>(1.0); H(1,2) = static_cast<Scalar>(0.0); H(1,3) = static_cast<Scalar>(0.0); H(1,4) = static_cast<Scalar>(0.0); H(1,5) = static_cast<Scalar>(0.0);
    H(2,0) = static_cast<Scalar>(0.0); H(2,1) = static_cast<Scalar>(0.0); H(2,2) = static_cast<Scalar>(1.0); H(2,3) = static_cast<Scalar>(0.0); H(2,4) = static_cast<Scalar>(0.0); H(2,5) = static_cast<Scalar>(0.0);
    ...
    dq_plus(0) = static_cast<Scalar>(1.0);
    dq_plus(1) = static_cast<Scalar>(0.5) * delta_alpha(0);
    dq_plus(2) = static_cast<Scalar>(0.5) * delta_alpha(1);
    dq_plus(3) = static_cast<Scalar>(0.5) * delta_alpha(2);
    dq_plus.normalize();
...
void ObserverClass::quest_update(const Quat& q_meas) {
    ...
    // Measurement residual 
    Vector3 y_tilde = static_cast<Scalar>(2)*delta_q.segment<3>(1);
...
ObserverClass::Quat ObserverClass::quest_algorithm(const Param::TimeReal& JD, 
                                     const Vector3& r_eci, 
                                     const Vector3& b_sun, 
                                     const Vector3& b_mag) {
    ...
    // Deifne weights 
    Scalar a_sun = static_cast<Scalar>(0.6);
    Scalar a_mag = static_cast<Scalar>(0.4);
...
ObserverClass::StateVector ObserverClass::update(const Param::Vector29& measurements, const TimeReal& t, const Scalar& dt) {
    ...
    bool new_star_update = (q_diff > static_cast<Scalar>(1e-6)) && valid_star_measurement;
...
ObserverClass::Vector3 ObserverClass::compute_r_mag(const Param::TimeReal& JD, 
                                                 const Vector3& r_eci) {
    ...
    Param::TimeReal decYearTime = static_cast<Param::TimeReal>(2000.0) + (JD - static_cast<Param::TimeReal>(2451545.0)) / static_cast<Param::TimeReal>(365.25);
