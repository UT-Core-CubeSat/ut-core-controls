...
void ObserverClass::propagate(const Vector3& omega_meas, Scalar dt) {
    ...
    F(3,0) = static_cast<Scalar>(0.0);          F(3,1) = static_cast<Scalar>(0.0);        F(3,2) = static_cast<Scalar>(0.0);         F(3,3) = static_cast<Scalar>(0.0);     F(3,4) = static_cast<Scalar>(0.0);      F(3,5) = static_cast<Scalar>(0.0);
    F(4,0) = static_cast<Scalar>(0.0);          F(4,1) = static_cast<Scalar>(0.0);        F(4,2) = static_cast<Scalar>(0.0);         F(4,3) = static_cast<Scalar>(0.0);     F(4,4) = static_cast<Scalar>(0.0);      F(4,5) = static_cast<Scalar>(0.0);
    F(5,0) = static_cast<Scalar>(0.0);          F(5,1) = static_cast<Scalar>(0.0);        F(5,2) = static_cast<Scalar>(0.0);         F(5,3) = static_cast<Scalar>(0.0);     F(5,4) = static_cast<Scalar>(0.0);      F(5,5) = static_cast<Scalar>(0.0);
    P = P + dt * (F * P + P * F.transpose() + G * Q * G.transpose());
