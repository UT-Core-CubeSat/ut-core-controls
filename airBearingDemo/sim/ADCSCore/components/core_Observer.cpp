...
ObserverClass::ObserverClass()
    ...
    epoch_time(static_cast<Scalar>(0.0)), 
    current_time(static_cast<Scalar>(0.0)),
    use_star_tracker(true),
    use_magnetometer(false),
    use_sun_sensor(false),
    last_star_update_time(static_cast<Scalar>(0.0)),
    last_quest_update_time(static_cast<Scalar>(0.0)),
...
ObserverClass::StateVector ObserverClass::update(const Param::Vector29& measurements, const Scalar& t, const Scalar& dt) {
...
ObserverClass::Vector3 ObserverClass::compute_r_mag(const Scalar& JD, 
    ...
    Scalar decYear = static_cast<Scalar>(2000.0) + (JD - static_cast<Scalar>(2451545.0)) / static_cast<Scalar>(365.25);
