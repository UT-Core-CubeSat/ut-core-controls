...
struct GroundTarget {
    Param::Real latitude;   // [deg] geodetic
    Param::Real longitude;  // [deg]
    Param::Real altitude;   // [m] above WGS84 ellipsoid (0 for ground stations)
};
...
// ============================================================================
struct SensorData {
    Param::Real unix_time;          // From GPS or RTC
...
private:
    ...
    Param::Real last_time; // Store last update time 
